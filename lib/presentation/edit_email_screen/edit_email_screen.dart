import 'bloc/edit_email_bloc.dart';
...
class EditEmailScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<EditEmailBloc>(
        create: (context) =>
            EditEmailBloc(EditEmailState(editEmailModelObj: EditEmailModel()))
              ..add(EditEmailInitialEvent()),
                          ...
                          child: Padding(
                              ...
                              child: Row(children: [
                                ...
                                Padding(
                                    ...
                                    child: Text("msg_edit_home_address".tr,
                                        style: CustomTextStyles
                                            .headlineSmallCabinetGrotesk))
                              ]))),
                      SizedBox(height: 41.v),
                      _buildArrowLeftAndEditHomeAddress(context),
                      SizedBox(height: 5.v),
  ...
  /// Section Widget
  Widget _buildArrowLeftAndEditHomeAddress(BuildContext context) {
    return Padding(
  ...
  Widget _buildName(BuildContext context) {
    return Padding(
        ...
        child:
            BlocSelector<EditEmailBloc, EditEmailState, TextEditingController?>(
  ...
  Widget _buildMobileNo(BuildContext context) {
    return BlocSelector<EditEmailBloc, EditEmailState, TextEditingController?>(
