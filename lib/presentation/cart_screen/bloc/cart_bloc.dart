...
import 'package:owoeye_s_application1/presentation/cart_screen/models/cart_model.dart';
...
class CartBloc extends Bloc<CartEvent, CartState> {
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        orderOnlyController: TextEditingController(),
        orderonlyController: TextEditingController(),
        installationOnlyController: TextEditingController()));
  }
}
